...
const conexionRemota = true // Variable para el estado de conexión
...
const flowSubMenuAutenticador = addKeyword<Provider, Database>(utils.setEvent('FLOW_AUTENTICADOR1'))
  .addAnswer('🔑 Este es el flujo para autenticador (en desarrollo)')
  .addAnswer('🔙 Escribe *menú* para volver al menú principal.')
